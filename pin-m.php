...
?>       
        ...
        <h5>-Fist Open Google Maps App.</h5>
        <h5>-Hold your finger on your house in Google Maps (The number 1 in the image below).</h5>
  ...
  <div class="row justify-content-center">
    <div class="col-md-6 col-lg-6 col-sm-12 text-center" style="padding-bottom: 20px">
     <h3 style="padding-bottom: 20px">The image : </h3>
        <img src="src/img/mob.jpg" class="img-fluid zoom" style="border-radius: 20%; " alt="mobile">
    </div>
